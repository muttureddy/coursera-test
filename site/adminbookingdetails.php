...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
  ...
  <div class="collapse navbar-collapse" id="navbarNavDropdown">
    <ul class="navbar-nav">
      ...
      <li class="nav-item active">
        <a class="nav-link" href="adminbookingdetails.php">Booking Details<span class="sr-only">(current)</span></a>
      </li>
      <li class="nav-item ">
    ...
    <h1 class="text-primary text-uppercase text-center">Booking Details</h1>
