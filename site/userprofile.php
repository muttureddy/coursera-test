...
$up = mysqli_query($con,"UPDATE login SET Password = '$_POST[password]', Email = '$_POST[email]',Lastname = '$_POST[lname]',Firstname = '$_POST[fname]' where Username = '$_POST[username]'");
