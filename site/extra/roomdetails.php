 ...
 <div class="content"> 
  ...
  <form class="form-horizontal"">
    ...
    <div class="form-group">
      ...
      <div class="col-sm-10">          
        <input value="<?php echo "$nation"; ?>" readonly class="form-control" >
      </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
      ...
      <div class="col-sm-10">          
        <input value="<?php echo "$troom"; ?>" readonly  class="form-control" >
      </div>
    </div>
    ...
    <div class="form-group">
      ...
      <div class="col-sm-10">          
        <input value="<?php echo "$people"; ?>"  readonly class="form-control" >
      </div>
    </div>
    <div class="form-group">
      <label class="control-label col-sm-2" for="pwd">Status:</label>
      <div class="col-sm-10">          
        <input value="<?php echo "$status"; ?>" readonly class="form-control" >
      </div>
    </div>
    <div class="form-group">
      <label class="control-label col-sm-2" for="pwd">Check In:</label>
      <div class="col-sm-10">          
        <input value="<?php echo "$cin"; ?>" readonly  class="form-control" >
      </div>
    </div>
    <div class="form-group">
      <label class="control-label col-sm-2" for="pwd">Check Out:</label>
      <div class="col-sm-10">          
        <input value="<?php echo "$cout"; ?>" readonly  class="form-control" >
      </div>
    </div>
    <div class="form-group">
      <label class="control-label col-sm-2" for="pwd">No.days:</label>
      <div class="col-sm-10">          
        <input value="<?php echo "$nodays"; ?>"  readonly class="form-control" >
      </div>
    </div>
  </form>  
